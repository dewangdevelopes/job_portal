          ...
          <section className="w-full">
            ...
            <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="relative w-full sm:w-[260px]">
                ...
                <input
                  type="text"
                  placeholder="Search by role, dept, type…"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-9 pr-9 py-2 text-[12px] bg-white border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 hover:border-slate-300 transition-all duration-200 placeholder:text-slate-400"
                />
                {searchQuery && (
                  <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
              {isLoading ? (
                ...
                <div className="col-span-3 flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <button
                    onClick={() => setSearchQuery("")}
                    className="mt-4 text-[12px] font-semibold text-slate-600 hover:text-slate-900 underline underline-offset-2 cursor-pointer transition-colors"
                  >
                    Clear search
                  </button>
                </div>
                ...
                filteredJobs.map((job, idx) => (
                  <div
                    ...
                    className="bg-white border border-slate-200/80 rounded-[16px] p-5 hover:shadow-md hover:-translate-y-0.5 hover:border-slate-300 transition-all duration-300 group flex flex-col justify-between cursor-pointer"
                  >
                    <div>
